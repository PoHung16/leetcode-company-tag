...
#    - last_states (Map): {button_id: state} tracks previous signal to detect edge transitions.

# C. Implement method:
#    - Use current_time (ms) for real-world precision.
    ...
    def process_event(self, button_id, current_state):
        ...
        # Case 2: 1 -> 0 (Falling Edge)
            ...
            if button_id in self.press_starts:
                start_time = self.press_starts.pop(button_id)
